...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
  <div id ="container">
	<div id="top">
	  <h1 class="header">Restaurante</h1>
	   <div id ="navbar">
			   <ul id = "navul">
				    <li><a href="restaurante.php" class="selected">Restaurante</a></li>
...
$database_name="turism";
	  ...
	  $result=$conn->query("SELECT idrestaurant FROM orasrestaurant WHERE idoras='$idoras'"); //incrementeaza id
	  $lengths = mysqli_num_rows($result);
	  $rows=$result->fetch_row();
	  echo "<table>";
	  while ( $rows =  $result->fetch_assoc() ) {
		  $idrestaurant=$rows['idrestaurant'];
		  $result2=$conn->query("SELECT * FROM restaurante WHERE idrestaurant='$idrestaurant'");
		  $row2=$result2->fetch_row();
		  
		  echo "<tr>
					<td><b> Restaurant:</b></td> <td>$row2[1] </td>
				</tr>" ;
