...
<head>
<meta charset="utf-8">
<title>Stergere restaurante</title>
...
<body>
 <div id ="container">
	<div id="top">
      ...
      <h1 class="header">&#350;tergere restaurant</h1>
	</div>
<div id="leftcontent">
<br>
  <br>
...
<table width="100%" border="1" frame="border"  >
  <tbody>
    <tr>
      <td>
     <form id="stergeRestaurant1" name="stergeRestaurantForm" method="GET" action="#">
      <input type="checkbox" name="stergeRestaurant" id="sterge">
      <label for="checkbox"><b>&#350;terge restaurant</b></label>
<br>
<br>
   ...
   <br />
   <br />
   <input type="submit" id="stergeRestaurant2" value="&#350;terge">
...
$database_name="turism";
	  ...
	  $script= "DELETE FROM restaurante WHERE nume='$nume' " ;
