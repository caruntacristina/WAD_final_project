...
<body>
 <div id ="container">
	<div id="top">
      ...
      <h1 class="header">Gestiune hoteluri</h1>
	</div>
<div id="leftcontent">
...
<table width="100%" border="1" frame="border"  >
  <tbody>
    <tr>
	  ...
	  <br>
<br>
     <form id="stergeHotel1" name="stergeHotelForm" method="GET" action="#">
      <label><b>&#350;terge hotel</b></label>
<br>
<br>
...
$database_name="turism";
	  ...
	  $script= "DELETE FROM hoteluri WHERE nume='$nume' " ;
